...
with open('random_gauss_x_coordinates.txt', 'w') as my_file:
    for i in rand_x_positions:
        np.savetxt(my_file, i)

with open('random_gauss_y_coordinates.txt', 'w') as my_file:
...
fig1.savefig('gaussian_3d_icetop2.png')
fig2.savefig('gaussian_2d_icetop2.png')
fig3.savefig('gaussian_3d_no_icetop2.png')
fig4.savefig('gaussian_2d_no_icetop2.png')
