...
"""#used to set the range for random.triangular()
...
""" low: low end of range for random number generator, inclusive
    high: high end of range for random number generator, inclusive
...
fig3 = plot_3d_no_icetop(rand_x_positions, rand_y_positions, gen2_dom_z_positions, "using triangular distribution")

fig4 = plot_2d_no_icetop(rand_x_positions, rand_y_positions, "using triangular distribution")
plt.show()


fig1.savefig('triangular_3d_icetop.png')
fig2.savefig('triangular_2d_icetop.png')
fig3.savefig('triangular_3d_no_icetop.png')
fig4.savefig('triangular_2d_no_icetop.png')
